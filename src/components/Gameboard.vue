          ...
          <v-card tile :color="playerMap[value.owner]">
            ...
            <v-fade-transition>
              <v-overlay v-if="hover" absolute color="#036358">
                <v-btn v-on:click="coordClick(index)">{{
                  getIndex(index)
                }}</v-btn>
              </v-overlay>
            </v-fade-transition>
  ...
  data() {
    return {
      ...
      fieldMap: new Map([
        [
          2,
          "https://cdn.discordapp.com/attachments/766231770445512715/786534037024014336/ryan-o-connor-tileable-grass.png"
        ],
        [
          1,
          "https://cdn.discordapp.com/attachments/766231770445512715/786534077545185300/dbwm528-78b11079-6ce9-4182-9166-d6c07af7d494.png"
        ],
        [
          0,
